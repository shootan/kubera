...
HRESULT OnCreateFBXDevice(ID3D11Device* pd3dDevice)
{
	HRESULT hr;
	WCHAR s[MAX_PATH];
	//V_RETURN(DXUTFindDXSDKMediaFileCch(s, MAX_PATH, L"blade_girl.FBX"));
	//V_RETURN(DXUTFindDXSDKMediaFileCch(s, MAX_PATH, L"micro_knight.FBX"));
	V_RETURN(DXUTFindDXSDKMediaFileCch(s, MAX_PATH, L"micro_wizard.FBX"));
	//V_RETURN(DXUTFindDXSDKMediaFileCch(s, MAX_PATH, L"floor.FBX"));
	std::wstring wstr(s);
	std::string str("");
	...
	void* pUserContext )
{
	...
	//LoadTexture(pd3dDevice, L"blade04 copy.tif");
	//LoadTexture(pd3dDevice, L"micro_knight.tif");
	//LoadTexture(pd3dDevice, L"floor.png");
	LoadTexture(pd3dDevice, L"micro_wizard_col.tif");
