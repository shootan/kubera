...
ParticleWizardSkillMesh::ParticleWizardSkillMesh(ID3D11Device *pd3dDevice) : CMesh(pd3dDevice)
{
	m_Texture = 0;
...
ParticleWizardSkillMesh::~ParticleWizardSkillMesh(void)
{
}

void ParticleWizardSkillMesh::Render(ID3D11DeviceContext *pd3dDeviceContext)
{
...
void ParticleWizardSkillMesh::CreateRasterizerState(ID3D11Device *pd3dDevice)
{
...
void ParticleWizardSkillMesh::RenderInstanced(ID3D11DeviceContext *pd3dDeviceContext, int nInstances, int nStartInstance)
{
...
bool ParticleWizardSkillMesh::Initialize(ID3D11Device* pd3dDevice, WCHAR* textureFilename)
{
	bool result;
...
bool ParticleWizardSkillMesh::InitializeBuffers(ID3D11Device* pd3dDevice)
{
...
bool ParticleWizardSkillMesh::LoadTexture(ID3D11Device* pd3dDevice, WCHAR* filename)
{
	bool result;
...
void ParticleWizardSkillMesh::ReleaseTexture()
{
	if(m_Texture)
	{
		m_Texture->Release();
...
ID3D11ShaderResourceView* ParticleWizardSkillMesh::GetTexture()
{
	return m_Texture->GetTexture();
}


int ParticleWizardSkillMesh::GetIndexCount()
{
	return m_nIndices;
}

bool ParticleWizardSkillMesh::InitializeParticleSystem()
{
	int i;
...
void ParticleWizardSkillMesh::EmitParticles(float frameTime)
{
...
void ParticleWizardSkillMesh::UpdateParticles(float frameTime)
{
	int i;
...
void ParticleWizardSkillMesh::KillParticles()
{
	int i, j;
...
bool ParticleWizardSkillMesh::UpdateBuffers(ID3D11DeviceContext* deviceContext)
{
	int index, i;
	HRESULT result;
...
void ParticleWizardSkillMesh::Frame(float frameTime)
{
	//bool result;
...
void ParticleWizardSkillMesh::SetCamVec(D3DXVECTOR3 _vCamRight, D3DXVECTOR3 _vCamUp)
{
